...
useEffect(()=>{
  ...
  return (
    <div>
      <Navbar/>
      <div className="min-h-[80vh] px-8 bg-red-200 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse md:items-start items-start">
        <div className="flex flex-col md:w-[70%] w-full mt-8 md:mt-0">
          <h1 className="text-xl mt-4 font-bold mb-4">Your posts:</h1>
          {posts?.map((p)=>(
        ...
        <h1 className="text-xl mt-4 font-bold mb-4">Profile</h1>
          <input onChange={(e)=>setUsername(e.target.value)} value={username} className="outline-none shadow-lg px-4 py-2 text-gray-500" placeholder="Your username" type="text"/>
          <input onChange={(e)=>setEmail(e.target.value)} value={email} className="outline-none shadow-lg px-4 py-2 text-gray-500" placeholder="Your email" type="email"/>
